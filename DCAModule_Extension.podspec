...
Pod::Spec.new do |s|
  ...
  s.name         = "DCAModule_Extension"
  s.version      = "1"
  s.summary      = "DCAModule_Extension."
  ...
  s.source       = { :git => "https://github.com/DCModularizationDemo/DCAModule.git", :tag => "Extension-"+s.version.to_s }
  ...
  s.source_files  = "DCAModule/DCAModule_Category/**/*.{h,m}"
